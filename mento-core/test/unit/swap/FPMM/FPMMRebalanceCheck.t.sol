...
contract FPMMRebalanceTest is FPMMBaseTest {
  ...
  function test_rebalance_check()
    public
    initializeFPMM_withDecimalTokens(18, 18)
    mintInitialLiquidity(18, 18)
    setupRebalancer(18, 18)
    // Set a small price difference
    withOracleRate(1.9e18, 1e18)
    ...
    withRecentRate(true)
  {
    ...
    // .5% < 5% (threshold)
    console.log("balance0:", fpmm.reserve0()/1e18);
    console.log("balance1:", fpmm.reserve1()/1e18);
    // uint256 
    uint256 rebalanceAmount = 6e18;
